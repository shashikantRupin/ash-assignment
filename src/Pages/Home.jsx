    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button color={"white"} bg={"#10C66F"} mr="2">
            More Details
          </Button>
        </Box>
      </Box>
      ...
      <Box w="90%" m="auto" mt={30}>
        <Center>
          <Heading pb={5} color="#10C66F">
            Featured Properties
          </Heading>
        </Center>
        <Center>
          <Text color="grey">
            Lorem ipsum dolor sit amet consectetur. Gravida et sit nibh accumsan
            arcu erat donec massa pulvinar.
          </Text>
        </Center>
        <Center>
          <Text color="grey">
            Rutrum pharetra id risus interdum. Donec proin quis mauris neque.
          </Text>
        </Center>
        <Grid
          templateColumns={{
          ...
          mt={10}
        >
          <Box boxShadow="0 2px 4px rgba(0, 0, 0, 0.2)" mb={isMobile ? 6 : 0}>
            <Image
              borderTopLeftRadius="10px"
              borderTopRightRadius="10px"
              w="100%"
              h={isMobile ? "auto" : "50%"}
              src="https://media.istockphoto.com/id/1333102002/photo/modern-style-bedroom-interior.jpg?s=612x612&w=0&k=20&c=rkG5eNaw4cHR24ZnWxEVm9FIgIBwuXHoZhULUk9E7-Q="
            />
            <Box ml={4} fontSize="sm" p={isMobile ? 5 : 4}>
              <Text>Mini Flat in Lekki Phase</Text>
              <Text color="#10C66F" fontWeight="bold">
                N 2,500,000/sq ft
              </Text>
      ...
      <Box w="90%" m="auto" mt={30}>
        ...
        <Center>
          <Text color="grey">
            Lorem ipsum dolor sit amet consectetur. Proin sagittis duis et sed
            egestas turpis ut aliquet ultricies. Risus
          </Text>
        </Center>
        <Center>
          <Text color="grey">
            vulputate semper orci neque. Eu egestas et ac sit pellentesque
            nullam.
          </Text>
        </Center>
        <Grid
        ...
        >
          ...
          >
            <Image
              ...
              margin="auto"
              h={isMobile ? "auto" : "60%"}
              src="https://www.hospitalitynet.org/picture/153125218/murphy.jpg?t=1616416546"
            />
          ...
          <Box boxShadow="0 4px 6px -1px rgba(0, 0, 0, 0.9)" width="100%">
            <Flex gap={6}>
              ...
              >
                ...
                <Text mt={{ base: 30, md: 5 }} color="grey">
